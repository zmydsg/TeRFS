...
- **Held-out temporal interpolation**: 1.52 dB median / 2.53 dB mean absolute RSS error across 60,240 unseen spatio-temporal samples.
- **TeRFS-Campus-5.9GHz dataset**: 100 frames, 5.9 GHz RSU, 2,008 receivers, 7 moving scatterers (6 vehicles + 1 UAV).
...
<p align="center">
  <img src="assets/dataset_snapshots.png" width="62%" alt="TeRFS-Campus-5.9GHz dataset"/>
</p>
